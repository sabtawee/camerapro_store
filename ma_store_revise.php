                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                <a href="ma_store_evaluation.php?id=<?php echo $row['id'] ?>" rel="noopener"
                                        class="btn btn-success" ><i class="fas fa-edit"></i> Add Evaluation File</a>
                                </td>
                                <td class="text-center">
                                <a href="ma_store_other.php?id=<?php echo $row['id'] ?>" rel="noopener"
                                        class="btn btn-primary" ><i class="fas fa-edit"></i> Add Other File</a>
                                </td>
                                <td class="text-center">
                                <a href="ma_store_re_up.php?id=<?php echo $row['id'] ?>" rel="noopener"
